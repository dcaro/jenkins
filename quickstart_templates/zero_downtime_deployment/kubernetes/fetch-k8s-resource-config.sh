...
#set defaults
config_files=()
artifacts_location="https://raw.githubusercontent.com/dcaro/jenkins/master"
...
for file in "${config_files[@]}"; do
    wget -O "$file" "${artifacts_location}/quickstart_templates/zero_downtime_deployment/kubernetes/resource_config/${file}${artifacts_location_sas_token}"
done
